...
int main(void) {
    ...
    int sortFlag, FinalsortFlag, systemClock = 0, timeQuantum, delay = 0, hold, count = 0, breakFlag = 1, loop, timeLeft, lockFlag, delayFlag = 0, delayTime, size = 0;
    char nameHold[100];
    ...
    printf("List of jobs (Sorted based on Completion Time.");
