...
int main(void) {
    ...
    switch (selection) {
    case('0'):
        printf("Shortest Job First (SJF) Preemptive Version.\n");
        break;
    case('1'):
        printf("Shortest Job First (SJF) Non-Preemptive Version.\n");
        break;
    ...
    int lowestAvgWaitingTimeIndex, lowestAvgTurnaroundTimeIndex, winner1, winner2, winner = 6;
    for (int i = 0; i < 6; i++) {
    ...
    printf("is the best algorithm based on this workload in ");
    ...
    if (winner1 != winner2) {
        ...
        printf("is the best algorithm based on this workload for lowest average turnaround time and ");
        ...
        printf("for the lowest average waiting time.\n");
